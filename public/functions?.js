function drawPlayer(playerImg) { // draw the player
    image(playerImg, thisPlayer.truckCoords.x, thisPlayer.truckCoords.y);
    if (playerHasGold) {
...
function Collision_right(coords, _side) {
    ...
    var objectX = objX + (_side / 2);
    var objectY = objY + (_side / 2);
